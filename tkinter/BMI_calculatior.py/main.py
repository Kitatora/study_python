...
class App(Frame):
    ...
    def __init__(self, master=None): #masterが第二引数？ただしNone
        #"""コンストラクタ"""
        # Frameクラスのコンストラクタを呼び
        super().__init__(master, padx=10, pady=10) #padxとは？
        # root（masterはrootを代入）にpackして配置 どこのroot?
        ...
        self.img = PhotoImage(file="/Users/minami.ryu/Documents/Github/study_python/tkinter/BMI_calculatior.py/img/1.png")
    ...
    def calc(self, _=None):
        ...
        try:
            ...
            if bmi < 18.5:
                ...
                self.img["file"] = "/Users/minami.ryu/Documents/Github/study_python/tkinter/BMI_calculatior.py/img/2.png"
                # self.lab7のimageを変える
                self.lab7["image"] = self.img

            elif 18.5 <= bmi < 25:
                result = "普通体重"
                self.img["file"] = "/Users/minami.ryu/Documents/Github/study_python/tkinter/BMI_calculatior.py/img/3.png"
                self.lab7["image"] = self.img

            elif 25 <= bmi < 30:
                result = "肥満（１度）"
                self.img["file"] = "/Users/minami.ryu/Documents/Github/study_python/tkinter/BMI_calculatior.py/img/4.png"
                self.lab7["image"] = self.img
    ...
    def clear(self):
        #"""リセットボタンが押されたら発動"""
        self.img["file"] = "/Users/minami.ryu/Documents/Github/study_python/tkinter/BMI_calculatior.py/img/1.png"
        self.lab7["image"] = self.img
        self.var1.set(self.initial)
